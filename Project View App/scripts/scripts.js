var tbody = document.querySelector('table tbody');
        ...
        function carregaEstudantes(){
            ...
            xhr.open('GET', `https://localhost:44306/api/Aluno`, true);
        ...
        function salvarEstudantes(metodo, id, corpo){
            ...
            xhr.open(metodo, `https://localhost:44306/api/Aluno/${id}`, false);
        ...
        function excluirEstudante(id){
            ...
            xhr.open("DELETE", `https://localhost:44306/api/Aluno/${id}`, false);
        ...
        function editarEstudante(estudante){
            ...
            //carregaEstudantes('PUT',id,estudante);
        }
        function deletarEstudante(id){
            aluno="";
            carregaEstudantes('DELETE',id,aluno);
        }
